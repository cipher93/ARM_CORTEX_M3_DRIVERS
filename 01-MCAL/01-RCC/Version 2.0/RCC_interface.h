...
/***************************/
/********Peripherals**********/
#define PORTA 		PORTA_MASK
#define PORTB 		PORTB_MASK
#define PORTC 		PORTC_MASK
#define PORTD 		PORTD_MASK
#define PORTE 		PORTE_MASK
#define PORTF 		PORTF_MASK
#define PORTG 		PORTG_MASK
#define PORTH 		PORTH_MASK
