...
/*Prescalars*/
#define 	RCC_AHB_PRESCALAR_1				RCC_AHB_PRESCALAR_1_MASK		
#define 	RCC_AHB_PRESCALAR_2				RCC_AHB_PRESCALAR_2_MASK		
#define 	RCC_AHB_PRESCALAR_4				RCC_AHB_PRESCALAR_4_MASK		
#define 	RCC_AHB_PRESCALAR_8				RCC_AHB_PRESCALAR_8_MASK		
#define 	RCC_AHB_PRESCALAR_16				RCC_AHB_PRESCALAR_16_MASK	
#define 	RCC_AHB_PRESCALAR_64				RCC_AHB_PRESCALAR_64_MASK	
#define 	RCC_AHB_PRESCALAR_128			RCC_AHB_PRESCALAR_128_MASK	
#define 	RCC_AHB_PRESCALAR_256			RCC_AHB_PRESCALAR_256_MASK	
#define 	RCC_AHB_PRESCALAR_512			RCC_AHB_PRESCALAR_512_MASK	
			    
#define 	RCC_APB1_PRESCALAR_1			RCC_APB1_PRESCALAR_1_MASK	
#define 	RCC_APB1_PRESCALAR_2			RCC_APB1_PRESCALAR_2_MASK	
#define 	RCC_APB1_PRESCALAR_4			RCC_APB1_PRESCALAR_4_MASK	
#define 	RCC_APB1_PRESCALAR_8			RCC_APB1_PRESCALAR_8_MASK	
#define 	RCC_APB1_PRESCALAR_16		RCC_APB1_PRESCALAR_16_MASK	
			    
#define 	RCC_APB2_PRESCALAR_1			RCC_APB2_PRESCALAR_1_MASK	
#define 	RCC_APB2_PRESCALAR_2			RCC_APB2_PRESCALAR_2_MASK	
#define 	RCC_APB2_PRESCALAR_4			RCC_APB2_PRESCALAR_4_MASK	
#define 	RCC_APB2_PRESCALAR_8			RCC_APB2_PRESCALAR_8_MASK	
#define 	RCC_APB2_PRESCALAR_16		RCC_APB2_PRESCALAR_16_MASK	
			    
#define 	RCC_ADC_PRESCALAR_2				RCC_ADC_PRESCALAR_2_MASK		
#define 	RCC_ADC_PRESCALAR_4				RCC_ADC_PRESCALAR_4_MASK		
#define 	RCC_ADC_PRESCALAR_6				RCC_ADC_PRESCALAR_6_MASK		
#define 	RCC_ADC_PRESCALAR_8				RCC_ADC_PRESCALAR_8_MASK		

/***************************/
/********Peripherals**********/
#define RCC_PERIPHERALS_PORTA 		RCC_PERIPHERALS_PORTA_MASK	
#define RCC_PERIPHERALS_PORTB 		RCC_PERIPHERALS_PORTB_MASK	
#define RCC_PERIPHERALS_PORTC 		RCC_PERIPHERALS_PORTC_MASK	
#define RCC_PERIPHERALS_PORTD 		RCC_PERIPHERALS_PORTD_MASK	
#define RCC_PERIPHERALS_PORTE 		RCC_PERIPHERALS_PORTE_MASK	
#define RCC_PERIPHERALS_PORTF 		RCC_PERIPHERALS_PORTF_MASK	
#define RCC_PERIPHERALS_PORTG 		RCC_PERIPHERALS_PORTG_MASK	
#define RCC_PERIPHERALS_PORTH 		RCC_PERIPHERALS_PORTH_MASK	
#define RCC_PERIPHERALS_USART1 		RCC_PERIPHERALS_USART1_MASK
#define RCC_PERIPHERALS_SPI1	        RCC_PERIPHERALS_SPI1_MASK		
#define RCC_PERIPHERALS_TIM1	        RCC_PERIPHERALS_TIM1_MASK		
#define RCC_PERIPHERALS_ADC1   	    RCC_PERIPHERALS_ADC1_MASK	
#define RCC_PERIPHERALS_ADC2     	    RCC_PERIPHERALS_ADC2_MASK	
...
#define RCC_AHB_PRESCALAR_1_MASK					((u32)~ (0b10000000))
#define RCC_AHB_PRESCALAR_2_MASK					((u32)(0b10000000))
#define RCC_AHB_PRESCALAR_4_MASK					((u32)(0b10010000))
#define RCC_AHB_PRESCALAR_8_MASK					((u32)(0b10100000))
#define RCC_AHB_PRESCALAR_16_MASK					((u32)(0b10110000))
#define RCC_AHB_PRESCALAR_64_MASK					((u32)(0b11000000))
#define RCC_AHB_PRESCALAR_128_MASK					((u32)(0b11010000))
#define RCC_AHB_PRESCALAR_256_MASK					((u32)(0b11100000))
#define RCC_AHB_PRESCALAR_512_MASK					((u32)(0b11110000))

#define RCC_APB1_PRESCALAR_1_MASK					((u32)~(0x400))
#define RCC_APB1_PRESCALAR_2_MASK					((u32)(0x400))
#define RCC_APB1_PRESCALAR_4_MASK					((u32)0x500)
#define RCC_APB1_PRESCALAR_8_MASK					((u32)0x600)
#define RCC_APB1_PRESCALAR_16_MASK					((u32)0x700)

#define RCC_APB2_PRESCALAR_1_MASK					((u32)~(0x2000))
#define RCC_APB2_PRESCALAR_2_MASK					((u32)(0x2000))
#define RCC_APB2_PRESCALAR_4_MASK					((u32)0x2800)
#define RCC_APB2_PRESCALAR_8_MASK					((u32)0x3000)
#define RCC_APB2_PRESCALAR_16_MASK					((u32)0x3800)

#define RCC_ADC_PRESCALAR_2_MASK					((u32)~(0xC000))
#define RCC_ADC_PRESCALAR_4_MASK					((u32)0x4000)
#define RCC_ADC_PRESCALAR_6_MASK					((u32)0x8000)
#define RCC_ADC_PRESCALAR_8_MASK					((u32)0xC000)

/******************************************************************/
/**************************Peripherals  Masks**************************/
#define RCC_PERIPHERALS_PORTA_MASK		 ((u32) 0x4)
#define RCC_PERIPHERALS_PORTB_MASK		 ((u32) 0x8)
#define RCC_PERIPHERALS_PORTC_MASK		 ((u32) 0x10)
#define RCC_PERIPHERALS_PORTD_MASK		 ((u32) 0x20)
#define RCC_PERIPHERALS_PORTE_MASK		 ((u32) 0x40)
#define RCC_PERIPHERALS_PORTF_MASK		 ((u32) 0x80)
#define RCC_PERIPHERALS_PORTG_MASK		 ((u32) 0x100)
#define RCC_PERIPHERALS_PORTH_MASK		 ((u32) 0x200)
#define RCC_PERIPHERALS_USART1_MASK		 ((u32) 0x4000)
#define RCC_PERIPHERALS_SPI1_MASK		 ((u32) 0x1000)
#define RCC_PERIPHERALS_TIM1_MASK		 ((u32) 0x800)
#define RCC_PERIPHERALS_ADC1_MASK		 ((u32) 0x200)
#define RCC_PERIPHERALS_ADC2_MASK		 ((u32) 0x400)
/*********************************************************/
