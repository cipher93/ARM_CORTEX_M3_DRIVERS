...
{
	/*And the passed mask with the register*/
	RCC_APB2ENR &= ~Copy_u32Peripheral;
...
{
	if (Copy_u32DesiredConfiguration == RCC_AHB_PRESCALAR_1_MASK || Copy_u32DesiredConfiguration == RCC_APB1_PRESCALAR_1_MASK || Copy_u32DesiredConfiguration == RCC_APB2_PRESCALAR_1_MASK ||Copy_u32DesiredConfiguration ==RCC_ADC_PRESCALAR_2_MASK)
	{
