...
#define RCC_PLL_MULTIPLIER_16				((u32)0x003C0000)
...
/*Get Prescalar value macros*/
#define RCC_GET_AHB_PRESCALAR							((u8)0)
#define RCC_GET_APB1_PRESCALAR							((u8)1)
#define RCC_GET_APB2_PRESCALAR							((u8)2)
...
/*******************************Masks******************************/
#define RCC_HSE_VALUE									(u32)8000000
/****************************CR Masks******************************/
...
extern u16 RCC_u16GetPrescalarValue(u8 Copy_u8DesiredBus);


/*Description: This API will be used to get PLL multiplier value
 * Parameters: void
 * Return: Multiplier value (u8)*/
extern f32 RCC_f32GetPLLMultiplierValue(void);
