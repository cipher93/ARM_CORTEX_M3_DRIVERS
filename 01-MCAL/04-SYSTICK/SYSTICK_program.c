...
#define 	SYSTICK_CTRL_ADDRESS			(u32*)(SYSTICK_BASE_ADDRESS + 0x00)
#define 	SYSTICK_LOAD_ADDRESS			(u32*)(SYSTICK_BASE_ADDRESS + 0x04)
#define 	SYSTICK_VAL_ADDRESS				(u32*)(SYSTICK_BASE_ADDRESS + 0x08)
#define 	SYSTICK_CALIB_ADDRESS			(u32*)(SYSTICK_BASE_ADDRESS + 0x0C)
