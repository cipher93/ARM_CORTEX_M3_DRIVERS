...
#include "HUART_interface.h"
 ...
 const UART_GPIO_t HUART_USART1 = {
		...
		.TX = {GPIO_PORT_A, GPIO_PIN9,GPIO_SPEED_OUTPUT_50 ,GPIO_MODE_OUTPUT_AF_PUSHPULL },
 ...
 const UART_GPIO_t HUART_USART2 = {
 		.TX = {GPIO_PORT_A, GPIO_PIN2, GPIO_SPEED_OUTPUT_50 ,GPIO_MODE_OUTPUT_AF_PUSHPULL},
 ...
 const UART_GPIO_t HUART_USART3 = {
 		.TX = {GPIO_PORT_B, GPIO_PIN10, GPIO_SPEED_OUTPUT_50 ,GPIO_MODE_OUTPUT_AF_PUSHPULL},
...
u8 HUART_u8Init(UART_GPIO_t Copy_u32PeripheralNumber, u32 Copy_u32Baudrate, u32 Copy_u32StopBits, u32 Copy_u32ParityBits)
{
	...
	/*Set RX pin as input pullup because this was proven from tests*/
